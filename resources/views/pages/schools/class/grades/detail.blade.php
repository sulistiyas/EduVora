...
>
    ...
    {{-- ══ MAIN GRID — 2 kolom: konten | sidebar ══════════ --}}
    <div class="detail-grid">

        {{-- ═══ KOLOM KIRI (konten utama) ═══ --}}
        <div class="detail-col">

            {{-- Edit status card — hanya muncul saat editing --}}
            <template x-if="isEditing">
            ...
            <div class="info-grid">
                ...
                </div>{{-- /card informasi kelas --}}

                {{-- Card kanan dalam info-grid: Ruangan + Tahun Ajaran --}}
                <div class="detail-col" style="gap:18px">
                    ...
                    <div class="card-v2" :class="isEditing ? 'is-editing-card' : ''" style="animation-delay:.06s">
                            ...
                            <div>
                                <div class="field-row-v2">
                                    ...
                                    <div class="field-content">
                                        ...
                                        <div class="field-val-v2" :class="!grade.room?.code ? 'is-empty' : ''"
                                            x-text="grade.room?.code || '—'"></div>
                                    </div>
                                </div>
                                <div class="field-row-v2">
                        ...
                        {{-- Placeholder jika belum ada ruangan dan tidak edit --}}
                    ...
                    <div class="card-v2" style="animation-delay:.08s">
                        ...
                        <div class="field-row-v2">
                            ...
                            <div class="field-content">
                                ...
                                <div class="field-val-v2"
                                    x-text="grade.academic_year?.start_date
                                        ? new Date(grade.academic_year.start_date).toLocaleDateString('id-ID',{day:'2-digit',month:'short',year:'numeric'})
                                        : '—'"></div>
                            </div>
                        </div>
                        <div class="field-row-v2">
                            ...
                            <div class="field-content">
                                ...
                                <div class="field-val-v2"
                                    x-text="grade.academic_year?.end_date
                                        ? new Date(grade.academic_year.end_date).toLocaleDateString('id-ID',{day:'2-digit',month:'short',year:'numeric'})
                                        : '—'"></div>
                            </div>
                        </div>
                        <div class="field-row-v2">
                ...
                </div>{{-- /right info-grid col --}}

            </div>{{-- /info-grid --}}

        </div>{{-- /kolom kiri --}}

        {{-- ═══ KOLOM KANAN (sidebar 320px) ═══ --}}
        <div class="detail-col">
    ...
    ══════════════════════════════════════════════════════════════ --}}
    <div style="margin-top:24px;animation:fadeUp .4s ease .15s both">
        <div style="display:flex;align-items:center;justify-content:space-between;gap:16px;margin-bottom:14px;flex-wrap:wrap">
            <div>
                ...
                <p style="font-size:12.5px;color:var(--text-muted);margin:3px 0 0">
                    Kelola daftar mata pelajaran yang diajarkan di kelas ini
                </p>
            </div>
            <div style="display:flex;gap:8px">
                        ...
                        <template x-if="loadingSubjects">
                            <template x-for="i in 4" :key="i">
                                <tr>
                                    ...
                                    <td>
                                        <div class="sk" style="width:140px;height:14px;margin-bottom:5px"></div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="font-size:13px;font-weight:600;color:var(--text-primary)"
                                            x-text="gs.subject?.subject_name || '—'"></div>
                                        <div style="font-size:11px;color:var(--text-muted);margin-top:1px"
                                            x-text="gs.subject?.code || ''"></div>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <template x-if="gs._editingTeacher">
                                            <div style="display:flex;gap:6px;align-items:center">
                                                <select x-model="gs._newTeacherId" class="add-subject-select"
                                    ...
                                    <td style="text-align:center">
                                        ...
                                        <template x-if="gs._editingKkm">
                                            <div style="display:flex;flex-direction:column;align-items:center;gap:4px">
                                                <input x-model="gs._newKkm" type="number" min="0" max="100"
                                                    class="kkm-input" placeholder="KKM">
                                        ...
                                        <template x-if="!gs._editingWeight">
                                            <div style="display:flex;align-items:center;justify-content:center;gap:4px">
                                                <div style="display:flex;gap:4px;align-items:center">
                                                    <span style="font-size:11px;font-weight:600;padding:2px 7px;border-radius:5px;background:#F0FDF4;color:#15803D;border:1px solid #BBF7D0"
                                                        x-text="(gs.weight_harian ?? 0) + '%'"></span>
                                                    <span style="font-size:10px;color:var(--text-muted)">/</span>
                                                    <span style="font-size:11px;font-weight:600;padding:2px 7px;border-radius:5px;background:#EFF6FF;color:#1D4ED8;border:1px solid #BFDBFE"
                                                        x-text="(gs.weight_uts ?? 0) + '%'"></span>
                                                    <span style="font-size:10px;color:var(--text-muted)">/</span>
                                                    <span style="font-size:11px;font-weight:600;padding:2px 7px;border-radius:5px;background:#FFF7ED;color:#C2410C;border:1px solid #FED7AA"
                                                        x-text="(gs.weight_uas ?? 0) + '%'"></span>
                                                </div>
                                    ...
                                    {{-- Aksi --}}
                                    <td style="text-align:center">
                                        <button @click="removeSubject(gs)"
                                            class="rm-subj-btn" title="Hapus mapel dari kelas">
            ...
            <div class="add-subject-row">
                ...
                <div>
                    ...
                    <button @click="addSubject()"
                        :disabled="!newSubjectId || addingSubject"
                        class="add-subj-btn">
