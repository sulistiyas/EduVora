...
use App\Http\Controllers\SchoolAdmin\AcademicDateController;
use App\Http\Controllers\SchoolAdmin\AttendanceController as SchoolAdminAttendanceController;
...
Route::middleware(['auth'])->group(function () {
    ...
    */
    ...
    Route::middleware(['role:super-admin,school-admin'])->group(function () {
        ...
        // School-Admin Attendance (read-only)
        Route::prefix('school-admin/attendance')->name('school-admin.attendance.')->group(function () {
            Route::get('/', [SchoolAdminAttendanceController::class, 'index'])->name('index');
            Route::get('/semesters', [SchoolAdminAttendanceController::class, 'semesters'])->name('semesters');
        });

        // Academic Dates
        Route::prefix('academic-dates')->name('academic-dates.')->group(function () {
            Route::get('/', [AcademicDateController::class, 'index'])->name('index');
            Route::post('/', [AcademicDateController::class, 'store'])->name('store');
            Route::get('/{id}', [AcademicDateController::class, 'show'])->name('show');
            Route::put('/{id}', [AcademicDateController::class, 'update'])->name('update');
            Route::delete('/{id}', [AcademicDateController::class, 'destroy'])->name('destroy');
        });
