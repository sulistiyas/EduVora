...
class UpdateSchoolRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'npsn' => ['nullable', 'string', 'max:50', 'unique:school_profiles,npsn,'.$this->route('id').',school_id'],
            'nss' => ['nullable', 'string', 'max:50', 'unique:school_profiles,nss,'.$this->route('id').',school_id'],
